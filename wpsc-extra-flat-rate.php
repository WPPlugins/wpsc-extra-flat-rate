...
class wpe_flatrate {
	...
	function wpe_flatrate() {
        ...
        add_action('wp_eCommerce_extra_flate_rate_about', array($this, 'wp_eCommerce_extra_flate_rate_about'));
       	add_action('wp_eCommerce_extra_flate_rate_other_plugins',array($this,'wp_eCommerce_extra_flate_rate_other_plugins' ) );
		...
		add_action( 'wp_ajax_add_plugin_user_wp_ecommerce',array($this,'wp_add_plugin_userfn') );
	...
	// function for other plugin feature tag 
	
	public function wp_eCommerce_extra_flate_rate_other_plugins ( ){ 
 ...
 function wp_eCommerce_flate_rate_admin_pointers () {
	...
	public function wp_add_plugin_userfn() { 
    	...
    	'blocking' => true,
    	'headers' => array(),
    	'body' => array('user'=>array('user_email'=>$email_id,'plugin_site' => $log_url,'status' => 1,'plugin_id' => '15','activation_date'=>$cur_date)),
    	'cookies' => array()));
